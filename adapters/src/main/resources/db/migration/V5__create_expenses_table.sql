...
CREATE TABLE expenses (
    ...
    -- Lower bound matches the earliest partition declared below. Without this,
    -- typos or stale data submitting historical dates would get an opaque
    -- "no partition found" error. CHECK turns it into a clean constraint violation.
    CONSTRAINT chk_date_partition_lower CHECK (expense_date >= '2023-01-01'),

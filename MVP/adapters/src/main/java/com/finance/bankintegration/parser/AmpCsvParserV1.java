...
// AMP Bank CSV export.
//
// Format assumed (signed amount; similar to CBA/ANZ):
//   col 0: Date            DD/MM/YYYY
//   col 1: Amount          signed decimal
//   col 2: Description     free text
//   col 3: Balance         IGNORED (optional)
//
// Verify against a real sample in B1.5.
@Component
public class AmpCsvParserV1 extends AbstractStreamingCsvParser {

    private static final DateTimeFormatter AMP_DATE = DateTimeFormatter.ofPattern("dd/MM/yyyy");
    private static final int MIN_COLUMNS = 3;

    @Override public String    bankId()         { return "amp"; }
    @Override public LocalDate validFromDate()  { return LocalDate.MIN; }
    @Override public String    versionTag()     { return "csv_amp_v1"; }

    @Override protected DateTimeFormatter dateFormat()     { return AMP_DATE; }

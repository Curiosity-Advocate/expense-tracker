...
// ANZ Internet Banking CSV export.
//
// Format assumed (signed amount; no header):
//   col 0: Date            DD/MM/YYYY
//   col 1: Amount          signed decimal
//   col 2: Description     free text (may be quoted because it can contain commas)
//   col 3: Balance         IGNORED (optional)
//
// Verify against a real sample in B1.5.
@Component
public class AnzCsvParserV1 extends AbstractStreamingCsvParser {

    private static final DateTimeFormatter ANZ_DATE = DateTimeFormatter.ofPattern("dd/MM/yyyy");
    private static final int MIN_COLUMNS = 3;

    @Override public String    bankId()         { return "anz"; }
    @Override public LocalDate validFromDate()  { return LocalDate.MIN; }
    @Override public String    versionTag()     { return "csv_anz_v1"; }

    @Override protected DateTimeFormatter dateFormat()     { return ANZ_DATE; }
